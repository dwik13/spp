...
<body>
    ...
    <header id="header" class="d-flex align-items-center">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <h1 class="logo"><a href="<?=base_url('home')?>">E-SPP</a></h1>
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" href="#permasalahan">Permasalahan</a></li>
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container position-relative" data-aos="fade-up" data-aos-delay="500">
            <h1>Welcome to E-SPP</h1>
            <h2>Electronic Applications
                Education Development Contribution</h2>
            <a href="<?=base_url('auth')?>" class="btn-get-started scrollto">Login</a>
        </div>
    </section><!-- End Hero -->
    ...
    <main id="main">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
                        <h3>Apa itu E-SPP?</h3>
                        <p class="fst-italic">
                            Elektronic SPP atau biasa disebut
                            E-SPP merupakan sebuah
                            aplikasi yang dapat membantu pihak
                            sekolah dalam mengelola
                            pembayaran
                            SPP siswa. Aplikasi ini menyajikan informasi data yang dapat Anda akses melalui web browser.
                            Dengan begitu, proses administrasi sekolah
                            menjadi lebih sederhana, sehingga sekolah dapat dengan mudah mengurus data siswa
                        </p>
                    </div>
                </div>
        ...
        <section id="permasalahan" class="services">
            <div class="container">

                <div class="section-title">
                    <span>PERMASALAHAN</span>
                    <h2>PERMASALAHAN</h2>
                    <p>Beberapa permasalahan yang dihadapi oleh Sekolah di Indonesia terkait
                        dalam penggunaan layanan Administrasi Keuangan SPP
                    </p>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up">
                        <div class="icon-box">
                            <div class="icon"><i aria-hidden="true" class="fas fa-user-times"></i></div>
                            <h4>
                                <p>Petugas yang
                                    kurang memadai dari sisi jumlah dan kualifikasi</p>
                            </h4>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="fade-up"
                        data-aos-delay="150">
                        <div class="icon-box">
                            <div class="icon"><i aria-hidden="true" class="fas fa-file-invoice"></i></div>
                            <h4>
                                <p>Pengerjaan manual
                                    berisiko ketidaktelitian dalam membuat laporan
                                    pembayaran SPP</p>
                            </h4>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="fade-up"
                        data-aos-delay="300">
                        <div class="icon-box">
                            <div class="icon"><i aria-hidden="true" class="fas fa-file-signature"></i></div>
                            <h4>
                                <p>Kesulitan
                                    melakukan perubahan jumlah tagihan jika ada perubahan
                                    jumlah pembayaran karena ada kegiatan tertentu</p>
                            </h4>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="fade-up"
                        data-aos-delay="450">
                        <div class="icon-box">
                            <div class="icon"><i aria-hidden="true" class="fas fa-file-excel"></i></div>
                            <h4>
                                <p>Slip pembayaran
                                    menumpuk dan bisa hilang</p>
                            </h4>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="fade-up"
                        data-aos-delay="600">
                        <div class="icon-box">
                            <div class="icon"><i aria-hidden="true" class="fas fa-user-clock"></i></div>
                            <h4>
                                <p>Terlalu lama
                                    merekap jumlah tunggakan SPP siswa yang harus ditagih</p>
                            </h4>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="fade-up"
                        ...
                        <div class="icon-box">
                            ...
                            <h4>
                                <p>Pencatatan
                                    pembayaran SPP masih manual dan butuh waktu lama merekap
                                    keadaan keuangan sekolah</p>
                            </h4>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4" data-aos="fade-up">
                        <div class="box">
                            <span>01</span>
                            <!-- <h4>Lorem Ipsum</h4> -->
                            <p>Sistem e-SPP dapat memaksimalkan pekerjaan bendahara dalam penyampaian informasi
                                pembayaran</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="150">
                        <div class="box">
                            ...
                            <p>meningkatkan keakuratan, kecepatan, serta ketetapan dalam pembuatan laporan sehingga
                                mengurangi kesalahan dalam laporan pembayaran. </p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="300">
                        <div class="box">
                            ...
                            <p>ketelitian maupunpelayanan administrasi pembayaran SPP dapat dilakukan secara efektif dan
                                efisien</p>
                        </div>
                    </div>
        ...
        <section id="cta" class="cta">
            <div class="container" data-aos="zoom-in">
                ...
                <div class="text-center">
                    <h3>Call To Login</h3>
                    <p> Aplikasi SPP Sekolah Berbasis Web E-SPP
                        Adalah Solusi Pengelolaan & Penagihan
                        SPP Sekolah Terbaik</p>
                    <a class="cta-btn" href="#">Call To Login</a>
                </div>
                ...
                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="150">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        ...
                        <div class="portfolio-info">
                            <h4>App 1</h4>
                            <p>App</p>
                            <a href="landingpage/img/portfolio/portfolio-1.jpg" data-gallery="portfolioGallery"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        ...
                        <div class="portfolio-info">
                            <h4>Web 3</h4>
                            <p>Web</p>
                            <a href="landingpage/img/portfolio/portfolio-2.jpg" data-gallery="portfolioGallery"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        ...
                        <div class="portfolio-info">
                            <h4>App 2</h4>
                            <p>App</p>
                            <a href="landingpage/img/portfolio/portfolio-3.jpg" data-gallery="portfolioGallery"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        ...
                        <div class="portfolio-info">
                            <h4>Card 2</h4>
                            <p>Card</p>
                            <a href="landingpage/img/portfolio/portfolio-4.jpg" data-gallery="portfolioGallery"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        ...
                        <div class="portfolio-info">
                            <h4>Web 2</h4>
                            <p>Web</p>
                            <a href="landingpage/img/portfolio/portfolio-5.jpg" data-gallery="portfolioGallery"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        ...
                        <div class="portfolio-info">
                            <h4>App 3</h4>
                            <p>App</p>
                            <a href="landingpage/img/portfolio/portfolio-6.jpg" data-gallery="portfolioGallery"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        ...
                        <div class="portfolio-info">
                            <h4>Card 1</h4>
                            <p>Card</p>
                            <a href="landingpage/img/portfolio/portfolio-7.jpg" data-gallery="portfolioGallery"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        ...
                        <div class="portfolio-info">
                            <h4>Card 3</h4>
                            <p>Card</p>
                            <a href="landingpage/img/portfolio/portfolio-8.jpg" data-gallery="portfolioGallery"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        ...
                        <div class="portfolio-info">
                            <h4>Web 3</h4>
                            <p>Web</p>
                            <a href="landingpage/img/portfolio/portfolio-9.jpg" data-gallery="portfolioGallery"
                                class="portfolio-lightbox preview-link" title="Web 3"><i class="bx bx-plus"></i></a>
                            <a href="portfolio-details.html" class="details-link" title="More Details"><i
                                    class="bx bx-link"></i></a>
                        </div>
                ...
                <div class="row" data-aos="fade-up">
                    <div class="col-lg-6">
                        <div class="info-box mb-4">
                            <i class="bx bx-map"></i>
                            <h3>Our Address</h3>
                            <p>Jl. Pelita no 27 Sidomekar - Semboro - Jember
    ...
    <footer id="footer">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="footer-info">
                            <h3>E-SPP</h3>
                            <p>
                                Jl. Pelita no 27 Sidomekar - Semboro - Jember
                                Jawa Timur, Indonesia<br><br>
                                <strong>Phone:</strong> +1 5589 55488 55<br>
                                <strong>Email:</strong> e-spp@gmail.com<br>
                            </p>
                    ...
                    <div class="col-lg-2 col-md-6 footer-links">
                        ...
                        <ul>
                            ...
                            <li><i class="bx bx-chevron-right"></i> <a href="#permasalahan">Permasalahan</a></li>
                            <li><i class="bx bx-chevron-right"></i> <a href="#keunggulan">Keunggulan</a></li>
                        </ul>
                    </div>
        ...
        <div class="container">
            <div class="copyright">
                &copy; Copyright <strong><span>E-SPP</span></strong>. All Rights Reserved
            </div>
            <div class="credits">
